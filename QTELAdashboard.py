    ...
    with col_left:
        st.markdown(
            ...
            <div style="text-align:left;">
                <h3 style="color:#00ffff; margin:0;">Ternyata, tingkat kepuasan mahasiswa terhadap fasilitas Twin Tower mencapai sekitar 70% yang menyebabkan peningkatan motivasi mahasiswa dalam belajar</h3>
